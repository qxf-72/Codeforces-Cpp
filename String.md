...
[**Tire.cpp**](/copypasta/String/Trie.cpp)
...
字典树的拓展应用，维护的不是字母，而是一个数的二进制表示的 0 和 1，可以将一组整插入字典树中，很方便的计算一个数和该组数中某一个数的最大异或值是多少。

### 模板代码

[**TrieXor.cpp**](/copypasta/String/TrieXor.cpp)
